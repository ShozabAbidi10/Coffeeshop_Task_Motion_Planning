...
private:
    ...
    void startEKF();
    double calculate_dist(double x1, double x2, double y1, double y2);
    double calculate_angle(double x1, double x2, double y1, double y2);
